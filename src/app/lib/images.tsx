...
export const newArrivalsImages = [
  ...
  },
  {
    ...
    price: "418.99",
    description:
      "(Product 17) Sample - Clothing And Accessory Boutiques For Sale",
  },
  {
    src: dressFive,
    alt: "five",
...
export const categoryImages = [
  { src: categoryOne, title: "editor's pick" },
  { src: categoryTwo, title: "shoes" },
  { src: categoryThree, title: "accessories" },
];
